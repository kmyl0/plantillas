...
module.exports={
  ...
  /** Funcion que procesa los datos ldap del usuario.
  ...
  procesaUsuario:(pDatos, pModeloUsuarioRol, pModeloUnidad, pModeloAuth, pModeloUsuario) => {
    ...
    return new Promise((resolve,reject) => {
      const insertar={
        // fid_unidad:pUnidad,
        usuario:pDatos.uid,
        contrasena:'', // TODO: Ver que introducir, o como hacer para que no valide el sequelize
        numero_documento:'1234567', // TODO: de donde viene este dato?
        nombres:pDatos.nombre,
      ...
      // module.exports.obtenerUnidad(pModeloUnidad, pModeloAuth, pDatos.uid)
      // .then(pUnidad => {
      //
      //     const insertar={
      //       fid_unidad:pUnidad,
  ...
  /** Funcion que obtiene el rol basado en una cadena de texto que es su cargo.
  ...
  /** Funcion que limpia una cadena de texto de acentos
  ...
  /** Funcion que hace una busqueda en la db para obtener los menus de un rol.
    ...
    @param {Numero} pIdRol identificador del rol, para el cual se obtiene los
    menus.
  ...
  /** Función que busca el rol de mayor peso.
    ...
    @param {Numero} pIdUsuario identificador del usuario.
  ...
  /** Funcion que obtiene los menus basado en los roles.
    @param {Modelo} pModeloRolMenu modelo de datos de la tabla rol_menu.
    @param {Modelo} pModeloMenu modelo de datos de la tabla menu.
