...
module.exports = app => {
  ...
  @apiParam (Peticion) {Texto} nombre  Nombre del menu
  @apiParam (Peticion) {Texto} descripcion Descripción del menu
  @apiParam (Peticion) {Numerico} _usuario_creacion Identificador del usuario que crea.
  ...
  @apiSuccess (Respuesta) {Numerico} id_menu Identificador del menu
  @apiSuccess (Respuesta) {Numerico} fid_menu_padre Identificador del menu padre
  @apiSuccess (Respuesta) {Texto} nombre Nombre del menu
  @apiSuccess (Respuesta) {Texto} descripcion Descripcion del menu
  @apiSuccess (Respuesta) {Numerico} orden Orden del menu
  ...
  @apiSuccess (Respuesta) {Numerico} _usuario_creacion Identificador del usuario de creación
  @apiSuccess (Respuesta) {Numerico} _usuario_modificacion Identificador del usuario de modificación
  ...
  */
  ...
  @apiParam {Numerico} id Identificador del menu
 ...
 */
  ...
  */
  ...
  @apiSampleRequest off
   */
  app.put('/api/v1/seguridad/menu/:id', sequelizeHandlers.update(menu));
