...
module.exports = app => {
  ...
  app.use(fileupload());
    ...
    app.use(cors({
        ...
        "headers": "Content-Type, Authorization, Content-Length, X-Requested-With, validacion",
